...
func Test_Encode64(t *testing.T) {
	...
	tests := []struct {
		...
		{"Standard encoding with padding and wrap after 137 (lenght of encoded line)", args{"testdata/100c.encode.input", base64.StdEncoding, 137}, "testdata/100c.encode.std.wrap-137.padded.golden", false},
		{"Standard encoding with padding and wrap after 200 (longer than lenght of encoded line)", args{"testdata/100c.encode.input", base64.StdEncoding, 200}, "testdata/100c.encode.std.wrap-200.padded.golden", false},
